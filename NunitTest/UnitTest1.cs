...
namespace NunitTest
{
    ...
    public class FormTest
    {
        ...
        [TestCase(@"Path\otomi_app-ver2.1\Test_file\Save")]//正しいとき
    ...
    public class OperateTest
    {
        ...
        [TestCase(@"Path\otomi_app-ver2.1\Test_file\Test.xlsx", 2, 2)]//有効な場合
        [TestCase(@"Path\otomi_app-ver2.1\Test_file\Test.xlsx ", 2, 2)]//有効な場合(スペースあり)
        [TestCase(@"　Path\otomi_app-ver2.1\Test_file\Test.xlsx", 2, 2)]//有効な場合(スペースあり)
    ...
    public class MemberTest
    {
        ...
        [TestCase(@"Path\otomi_app-ver2.1\Test_file\Test1.xlsx ", 2, 2)]//有効な場合(スペースあり)
        [TestCase(@"　Path\otomi_app-ver2.1\Test_file\Test1.xlsx", 2, 2)]//有効な場合(スペースあり)
        //Operate_SetfromExcel関数のテスト
    ...
    public class AlbumTest
    {
        ...
        [TestCase(@"　Path\otomi_app-ver2.1\Test_file\Test2.xlsx", 2, 6)]//スペースあり(全角)
        [TestCase(@"Path\otomi_app-ver2.1\Test_file\Test2.xlsx ", 2, 6)]//スペースあり(半角)
        //Operate_SetfromExcel関数のテスト
        public void SetExcel_Test(String pass, int start, int end)
        {
            //辞書型変数を定義
